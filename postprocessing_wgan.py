...
def write_midi(sequence, number):
    ...
    all_parts.write('midi', './midi/sample_' + str(number) + '.mid')


def main(DATA, num_samples, sample_size):
    # load sequence file
    ...
    sequence = inverse_mapping(tokens)
    for i in range(num_samples):
        write_midi(sequence[i*sample_size: i*sample_size + sample_size], i)
